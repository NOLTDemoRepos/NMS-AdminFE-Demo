        ...
        <div className="bg-[#111d26]/80 backdrop-blur-xl rounded-[40px] shadow-2xl border border-white/5 overflow-hidden transition-all duration-500">
          <div className="p-8 md:p-12">
            ...
            <div className="mt-8 pt-8 border-t border-white/5 text-center">
              <a 
                href="#" 
                className="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl bg-white/5 border border-white/10 text-white font-black uppercase text-[11px] tracking-widest hover:bg-white/10 transition-all group"
                onClick={(e) => e.preventDefault()}
              >
                <span className="material-symbols-outlined text-[18px] group-hover:scale-110 transition-transform">person_outline</span>
