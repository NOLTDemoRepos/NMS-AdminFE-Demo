    ...
    <header className="sticky top-0 z-30 flex items-center justify-between px-6 py-4 bg-white/80 dark:bg-surface-darker/80 backdrop-blur-md border-b border-slate-100 dark:border-slate-800/50 transition-colors duration-300">
      <div className="flex items-center gap-4 flex-1">
        ...
        <div className="relative w-full max-w-lg hidden sm:block">
          ...
          <input 
            className="block w-full pl-12 pr-4 py-3 border border-transparent rounded-2xl leading-5 bg-slate-100 dark:bg-surface-dark text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-primary sm:text-sm shadow-none transition-all" 
